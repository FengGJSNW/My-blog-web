(function() {
  var Log, OmegaTargetCurrent, Promise, dispName, startupCheck, zeroBackground,
  ...
  zeroBackground = function(zeroStorage, opts) {
    var actionForUrl, charCodeUnderscore, drawContext, drawError, drawIcon, encodeError, external, iconCache, isHidden, options, proxyImpl, refreshActivePageIfEnabled, resetAllOptions, state, storage, sync, syncStorage, tabs, timeout, unhandledPromises, unhandledPromisesId, unhandledPromisesNextId, _ref, _ref1;
    unhandledPromises = [];
    unhandledPromisesId = [];
    ...
    drawIcon = function(resultColor, profileColor) {
      var cacheKey, canvas, e, icon, size, _i, _len, _ref;
